...
export default defineConfig({
  ...
  theme: {
    extend: {
      ...
      // ── Semantic Tokens ───────────────────────────────────────
      // Gremlin is dark-default with a light theme variant via [data-color-mode="light"]
      semanticTokens: {
        colors: {
          bg: {
            overlay: {
      ...
      keyframes: {
        ...
        // Squash — button press compression
        squash: {
          from: { transform: "scaleY(1) scaleX(1)" },
          to: { transform: "scaleY(0.92) scaleX(1.06)" },
        },
        // Stretch — button hover inflation
        stretch: {
          from: { transform: "scaleY(1) scaleX(1)" },
          to: { transform: "scaleY(1.02) scaleX(0.98)" },
        },
        // Mouth open — dropdown scaleY entrance
        mouthOpen: {
          from: { opacity: "0", transform: "scaleY(0.8)" },
          to: { opacity: "1", transform: "scaleY(1)" },
        },
        // Asterisk pop — required indicator scale-in
        asteriskPop: {
          from: { opacity: "0", transform: "scale(0)" },
          to: { opacity: "1", transform: "scale(1)" },
        },
        // Error reveal — scale down from zero height with fade (GPU-compositable)
        errorReveal: {
        ...
        // Hero title entrance — scale with tilt
        heroTitleIn: {
        ...
        // Idle wobble — subtle breathing animation
        idleWobble: {
          "0%, 100%": { transform: "rotate(0deg)" },
          "25%": { transform: "rotate(2deg)" },
          "75%": { transform: "rotate(-2deg)" },
        },
        // Pupil shift — for decorative watching eyes
        pupilShift: {
          "0%, 100%": { transform: "translateX(0)" },
