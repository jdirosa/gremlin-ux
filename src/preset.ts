    ...
    extend: {
      ...
      tokens: {
        ...
        animations: {
          ...
          drawerSlideInRight: { value: "drawerSlideInRight {durations.slow} {easings.rubber}" },
          drawerSlideOutRight: { value: "drawerSlideOutRight {durations.normal} {easings.in}" },
          drawerSlideInLeft: { value: "drawerSlideInLeft {durations.slow} {easings.rubber}" },
          drawerSlideOutLeft: { value: "drawerSlideOutLeft {durations.normal} {easings.in}" },
        },
      },
      ...
      keyframes: {
        ...
        drawerSlideInRight: {
          ...
          "60%": { transform: "translateX(-3%) scaleX(1.02)" },
          "80%": { transform: "translateX(1%) scaleX(0.99)" },
          "100%": { transform: "translateX(0) scaleX(1)" },
        },
        drawerSlideOutRight: {
          "0%": { transform: "translateX(0) scaleX(1)" },
          "30%": { transform: "translateX(-2%) scaleX(1.01)" },
